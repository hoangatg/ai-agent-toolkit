...
description: Strategic product leader bridging business needs and technical execution. Expert in requirements, user stories, roadmap management, backlog prioritization, and product strategy. Triggers on requirements, user story, acceptance criteria, product specs, backlog, MVP, PRD, stakeholder, roadmap.
tools: Read, Grep, Glob, Bash
model: inherit
skills: plan-writing, brainstorming, clean-code, product-manager-toolkit, pricing-strategy, copywriting
---
